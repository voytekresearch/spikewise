...
class Spike:
    ...
    def plot(self, inds=None, mode='full', in_ms=True, show_points=False, ax=None, groups=False, ind_groups=None, group_names=None, plot_average=False, plot_average_std=False, color='C0', peak_align=True):
        """Plot fits.
        ...
        # Plot
        plot_model(self, inds, mode, in_ms, show_points, ax, groups, ind_groups, group_names, plot_average, plot_average_std, color, peak_align=peak_align)
